...
# get file
wget -O /etc/openvpn.zip "https://www.dropbox.com/s/9ltzd9r7cntydeh/premium.zip"
cd /etc/
unzip openvpn.zip
cd
wget -O /var/var.zip "https://www.dropbox.com/s/dx1trblfm46mja8/var.zip"
cd /var/
unzip var.zip
cd
...
wget -O /etc/stunnel/stunnel.conf "https://www.dropbox.com/s/i0uwsljpuq5fvvp/stunnel.conf"
wget -O /etc/stunnel/stunnel.pem "https://www.dropbox.com/s/2k9wtdsbgqqz19j/stunnel.pem"
chown nobody:nobody /var/run/stunnel
wget -O /etc/rc.d/init.d/stunnel "https://www.dropbox.com/s/vmnuwj4a7am64lb/stunnel"
...
wget -O /etc/init.d/dropbear "https://www.dropbox.com/s/2b17og6n7pqi8bm/dropbear"
...
#       Setup by: bunoy - Project Team /    #
#          Server System: Storm VPN         #
#            owner: Project - VPN TEAM      #
#############################################';
